...
export default function ConnectWalletPage() {
    ...
    return (
        <div className="min-h-screen bg-[#0b0a11] text-white grid place-items-center px-4 py-10 overflow-x-hidden">
            ...
            <div className="relative flex flex-col items-center w-full max-w-sm">
                        ...
                        {availableWallets.map((wallet, id) => {
                            return (
                                <div
                                    ...
                                    role="button"
                                    tabIndex={0}
                                    className="flex items-center px-3 py-3 min-h-11 rounded-lg bg-white/20 backdrop-blur-md border border-white/10 shadow-xl justify-between w-[calc(100%-1rem)] mx-auto cursor-pointer"
                ...
                <div className="mt-8 w-full border rounded-md border-pink-300 mx-auto py-4 flex gap-2 items-center px-2">
                    <OctagonAlert className="size-6 shrink-0 text-pink-300"/>
